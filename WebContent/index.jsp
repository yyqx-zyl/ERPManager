		...
		<div class="dvheader">
			<div class="dvheadertools">
				...
				<ul class="headerultools">
					...
					<li><a style="color: white; text-decoration: none;" href="${ctx }/loginOut">退出</a></li>
				</ul>
			</div>
		</div>
		<div class="dvcontent">
			...
			<ul class="ulleftmenu" style="border-right: 1px solid #ddd;">
				...
				<li class="limenuitem">
					...
					<ul class="ulleftsubitems">
						<c:if test="${loginUser.userrole == 0 }" var="notAdmin">
							...
							<a href="${ctx }/inbound/getInboundList" target="right">
								<li>入库管理</li>
							</a>
							<a href="${ctx }/warn/getWarnList" target="right">
								<li>预警信息设置</li>
							</a>
							<a href="${ctx }/out/getOutBoudList" target="right">
								<li>出库管理</li>
							</a>
							<a href="${ctx}/getUserList" target="right">
								<li>用户管理</li>
							</a>
