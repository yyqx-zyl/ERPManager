	...
	<div class="dvcontent">
						...
						<li>
							...
							<div id="dv1">
								<table class="table" id="tbRecord">
									...
									<tbody>
										<c:forEach items="${pageInfo.list }" var="warn">
											<tr>
												<td>${warn.wid }</td>
												...
												<td class="edit"><button
														onclick="btn_edit(${warn.wid })" data-toggle="modal"
														data-target="#myModal">
														<i class="icon-edit bigger-120"></i>编辑
													</button></td>
												<td class="delete"><button
														onclick="btn_delete(${warn.wid })">
								...
								<div id="div_pagination_bottom">
									<nav aria-label="Page navigation">
										<ul class="pagination">
											<li><a
												href="${ctx}/warn/getWarnList?currpage=${pageInfo.pageNum-1}"
											...
											<c:forEach items="${pageInfo.navigatepageNums }"
												...
												<c:if test="${page_Num != pageInfo.pageNum }">
													<li><a style="margin-top: 7px;"
														href="${ctx}/warn/getWarnList?currpage=${ page_Num}">${ page_Num}</a>
													</li>
												</c:if>
											</c:forEach>
											<li><a
									...
									<div class="admin-content-body">
										...
										<div class="am-g">
											...
											<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4"
												...
												<form class="am-form am-form-horizontal" action="saveWarn"
													method="post">
													...
													<div class="am-form-group">
														<label for="editWarnNum" class="am-u-sm-3 am-form-label">
															数量</label>
														<div class="am-u-sm-9">
															<input type="text" id="editWarnNum" required
																placeholder="预警数量" name="warnNum"> <small>预警数量</small>
														</div>
													</div>
													<div class="am-form-group">
					...
					<div class="modal-body">
						<form class="am-form am-form-horizontal" id="updateForm"
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" id="warnNum" required placeholder="预警数量"
										name="warnNum"> <small>预警数量</small>
								</div>
							</div>
							<div class="am-form-group">
		...
		<script>
					...
					var btn_delete = function(id) {
						$.get("${ctx}/warn/deleteWarn",{id:id},function(data){
							if(data.result>0){
								$.jq_Confirm({
									message: "您确定要删除吗?",
									btnOkClick: function() {
