	...
	<body>
		<div class="dvcontent">
										...
										<tbody>
											<c:forEach items="${pageInfo.list }" var="warn">
												<tr>
													...
													<td class="delete"><button onclick="btn_delete(${warn.wid })"><i class="icon-trash bigger-120"></i>删除</button></td>
												</tr>
											</c:forEach>
										</tbody>
            ...
            <nav aria-label="Page navigation">
                <ul class="pagination">
                     <li>
                         <a href="${ctx}/warn/getWarnList?currpage=${pageInfo.pageNum-1}"
                           aria-label="Previous">
                     ...
                     <c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
                         ...
                         <c:if test="${page_Num != pageInfo.pageNum }">
                            <li>
                                 <a style="margin-top: 7px;" href="${ctx}/warn/getWarnList?currpage=${ page_Num}">${ page_Num}</a>
                            </li>
                        </c:if>
                     </c:forEach>
                    <li>
