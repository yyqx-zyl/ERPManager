...
<body>
	<div class="dvcontent">
		...
		<div>
			...
			<div class="tabs">
				<div class="hd">
					<ul>
						<li class="on"
							style="box-sizing: initial; -webkit-box-sizing: initial;">出库记录</li>
						<li class=""
							style="box-sizing: initial; -webkit-box-sizing: initial;">商品出库</li>
					</ul>
				</div>
				<div class="bd">
							...
							<div id="dv1">
									...
									<tbody>
										<c:forEach items="${pageInfo.list }" var="out">
											<tr>
												...
												<td>${out.outNum }</td>
												<td><fmt:formatDate value="${out.createTime }"
														pattern="yyyy-mm-dd" /></td>
												<td class="edit"><button
														onclick="btn_edit(${out.oid })" data-toggle="modal"
														data-target="#myModal">
														<i class="icon-edit bigger-120"></i>编辑
													</button></td>
												<td class="delete"><button
														onclick="btn_delete(${out.oid })">
								...
								<div id="div_pagination_bottom">
									<nav aria-label="Page navigation">
										<ul class="pagination">
											<li><a
												href="${ctx}/out/getOutBoudList?currpage=${pageInfo.pageNum-1}"
											...
											<c:forEach items="${pageInfo.navigatepageNums }"
												...
												<c:if test="${page_Num == pageInfo.pageNum }">
													<li class="active"><a href="#"
														style="margin-top: 7px;">${ page_Num}</a></li>
												</c:if>
												<c:if test="${page_Num != pageInfo.pageNum }">
													<li><a style="margin-top: 7px;"
														href="${ctx}/out/getOutBoudList?currpage=${ page_Num}">${ page_Num}</a>
													</li>
												</c:if>
											</c:forEach>
											<li><a
										...
										<div class="am-g">
											...
											<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4"
												...
												<form class="am-form am-form-horizontal"
													action="saveOutBoud" method="post">
													...
													<div class="am-form-group">
														<label for="editOutNum" class="am-u-sm-3 am-form-label">
															数量</label>
														<div class="am-u-sm-9">
															<input type="text" id="editOutNum" required
																placeholder="预警数量" name="outNum"> <small>预警数量</small>
														</div>
													</div>
													<div class="am-form-group">
														<label for="editRemark" class="am-u-sm-3 am-form-label">
															备注</label>
														<div class="am-u-sm-9">
															<textarea class="" rows="5" id="editRemark" name="remark"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModalLabel">修改预警信息</h4>
						</div>
						<div class="modal-body">
							<form class="am-form am-form-horizontal" id="updateForm"
								...
								<div class="am-form-group">
									<label for="name" class="am-u-sm-3 am-form-label"> 数量</label>
									<div class="am-u-sm-9">
										<input type="text" id="outNum" required placeholder="预警数量"
											name="outNum"> <small>预警数量</small>
									</div>
								</div>
								<div class="am-form-group">
					...
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary"
							onclick="but_update()">提交更改</button>
					</div>
				</div>
				<!-- /.modal-content -->
			</div>
		...
		<script src="${ctx }/static/js/plugs/Jqueryplugs.js"
